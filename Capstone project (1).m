...
function rcValues = tuneModel
  % Slight adjustments to fine-tune the model
  rcValues = [16.7; 10.6; 80]; % Example: Slight adjustments to R0, R1, and C1
  rcValues = rcValues(:); % Ensure output is a column vector
end
